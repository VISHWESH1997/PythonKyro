'''
This program is used to find the most frequent or most recent items
from inputs given in file as orders 1,order 2 etc. in the past
30 days.
'''
...
'''
   This below function is used to take inputs from the file and
   create a list for ordered items in last 30 days.
'''
def inputs():
    ...
    if (ord == 'y'):
        try:
            ...
            print (" Please check the file is correct or not or in right directory ", e)
            exit(0)
        for line in b:
            days=0
            temp=[]
...
'''
 This function work is used to find the most recent or most
 frequent items of the ordered items from the sample.txt
 file.
'''
